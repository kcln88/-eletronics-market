...
#   product16.save!
  ...
  product2.photos.attach(io: file2, filename: "product2.png", content_type: "image/png")
  product2.save!
  ...
  product3.photos.attach(io: file3, filename: "product3.png", content_type: "image/png")
  product3.save!
  ...
  product4.photos.attach(io: file4, filename: "product4.png", content_type: "image/png")
  product4.save!
  # CADEIRAS
  ...
  product5.photos.attach(io: file5, filename: "product5.png", content_type: "image/png")
  product5.save!
  ...
  product6.photos.attach(io: file6, filename: "product6.png", content_type: "image/png")
  product6.save!
  ...
  product7.photos.attach(io: file7, filename: "product7.png", content_type: "image/png")
  product7.save!
  ...
  product8.photos.attach(io: file8, filename: "product8.png", content_type: "image/png")
  product8.save!
  # NOTEBOOKS
  ...
  product9.photos.attach(io: file9, filename: "product9.png", content_type: "image/png")
  product9.save!
  ...
  product10.photos.attach(io: file10, filename: "product10.png", content_type: "image/png")
  product10.save!
  ...
  product11.photos.attach(io: file11, filename: "product11.png", content_type: "image/png")
  product11.save!
  ...
  product12.photos.attach(io: file12, filename: "product12.png", content_type: "image/png")
  product12.save!
  #CELULARES
  ...
  product13.photos.attach(io: file13, filename: "product13.png", content_type: "image/png")
  product13.save!
  ...
  product14.photos.attach(io: file14, filename: "product14.png", content_type: "image/png")
  product14.save!
  ...
  product15.photos.attach(io: file15, filename: "product15.png", content_type: "image/png")
  product15.save!
  file16 = URI.open("https://www.fastshop.com.br//wcsstore/FastShopCAS/images/catalog/AEMPV03BRARXO_PRD/AEMPV03BRARXO_PRD_447_1.jpeg")
