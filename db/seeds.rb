...
user3.save!
  ...
  product4 = Product.new(name: 'Pacote com 2 cabos USB C de 3 m', price: 19.89, description: 'Carregamento rápido 3A, cabo de carregamento USB A para tipo C, trançado compatível com Samsung Galaxy A10e A20 A50 A51 A71, S20 S10 S9 S8 Plus S10E, Note 20 10 9 8, Moto G7 G8.', stock: 17, category: 'Acessórios', user_id:2)
  ...
  product5 = Product.new(name: 'Cadeira Gamer Moob Reclinável GT Racer', price: 1300, description: 'A Cadeira Gamer Moob GT Racer combina estilo e ergonomia para proporcionar o máximo conforto durante suas sessões de jogo.', stock: 30, category: 'Cadeiras', user_id:1)
  ...
  product6 = Product.new(name: 'HAVIT CADEIRA GAMER ', price: 1300, description: 'A Cadeira Gamer HAVIT combina estilo e ergonomia para proporcionar o máximo conforto durante suas sessões de jogo.', stock: 30, category: 'Cadeiras', user_id:1)
  ...
  product7 = Product.new(name: 'CADEIRA GAMER MANCER', price: 1300, description: 'Para quem passa horas imerso no mundo dos jogos, uma cadeira confortável e de qualidade é o mínimo.', stock: 30, category: 'Cadeiras', user_id:1)
  ...
  product8 = Product.new(name: 'Thunderx3 Tc3 Cadeira Gamer Tc3 All White, Branca', price: 1300, description: 'Para quem passa horas imerso no mundo dos jogos, uma cadeira confortável e de qualidade é o mínimo.', stock: 30, category: 'Cadeiras', user_id:1)
  ...
  product9 = Product.new(name: 'Notebook Inspiron 15', price: 2199, description: 'Processador 12ª geração Intel® Core™ i3-1215U (6-core, cache de 10MB, até 4.4GHz)', stock: 30, category: 'Notebooks', user_id: 1)
  ...
  product10 = Product.new(name: 'Notebook Samsung Galaxy Book2r', price: 2204.67, description: 'Intel Core i3-1215U, Windows 11 Home, 8GB, 256GB SSD, 15.6 Full HD LED 15.6', stock: 27, category: 'Notebooks', user_id:1)
  ...
  product11 = Product.new(name: 'Notebook VAIO®', price: 2499.69, description: 'FE15 AMD® Ryzen 5 Linux 16GB 512GB SSD Full HD - Prata Titânio', stock: 63, category: 'Notebooks', user_id:2)
  ...
  product12 = Product.new(name: 'Notebook Asus Vivobook 15', price: 1300, description: 'Intel Pentium Gold 4GB 128GB SSD Tela 15,6" e Windows 11 Home X1500EA-EJ4242WS', stock: 36, category: 'Notebooks', user_id:1)
  ...
  ', price: 1500, description: 'Capture imagens incrivelmente nítidas mesmo em ambientes com pouca luz e grave vídeos fluidos com nossa câmera de 50 MP, equipada com Estabilização Óptica de Imagem (OIS), que corrige automaticamente qualquer movimento acidental ', stock: 10, category: 'Smartphones', user_id:2)
